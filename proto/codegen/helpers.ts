...
declare let globalThis: any | undefined;
// declare const globalThis: any | undefined;
...
export function toDuration(duration: string): Duration {
  return {
    seconds: Long.fromNumber(Math.floor(parseInt(duration, 10) / 1000000000)),
    nanos: parseInt(duration, 10) % 1000000000,
  };
}

export function fromDuration(duration: Duration): string {
  return (
    parseInt(duration.seconds.toString(), 10) * 1000000000 +
    duration.nanos
  ).toString();
}
